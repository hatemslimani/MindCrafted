        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="text-muted mb-0">
                    ...
                    <?php echo e(count($group)); ?> groupes au total
                </p>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="group-card">
                <div class="group-card-header">
                    <h3 class="group-name"><?php echo e($grp->name); ?></h3>
                    <div class="group-actions">
                        <button class="btn btn-icon" data-toggle="modal" data-target="#editGroup<?php echo e($grp->id); ?>" title="Modifier">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-icon" onclick="showDeleteGroupConfirmation('<?php echo e($grp->id); ?>', '<?php echo e($grp->name); ?>')" title="Supprimer">
                ...
                <div class="group-card-body">
                    <div class="group-stats">
                        <div class="stat-item">
                            ...
                            <span><?php echo e($grp->studentCount); ?> Étudiants</span>
                        </div>
                        <div class="stat-item">
                            <i class="fas fa-book"></i>
                            <span><?php echo e($grp->sectionCount); ?> Sections</span>
                        </div>
                    </div>
                    <a href="<?php echo e(url('admin/infoGroup/'.$grp->id)); ?>" class="btn btn-outline-primary btn-block mt-3">
            ...
            <!-- Modal Modification -->
            <div class="modal fade" id="editGroup<?php echo e($grp->id); ?>" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(url('admin/updateNameGroupe/'.$grp->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Nom du groupe</label>
                                    <input type="text" name="namee" class="form-control" value="<?php echo e($grp->name); ?>" required>
                                </div>
                            </div>
...
<div class="modal fade" id="addGroupModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/addGroup')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nom du groupe</label>
...
function confirmDelete(id) {
    if(confirm('Êtes-vous sûr de vouloir supprimer ce groupe ?')) {
        window.location.href = "<?php echo e(url('admin/deleteGroup')); ?>/" + id;
    }
}
...
function showDeleteGroupConfirmation(groupId, groupName) {
    ...
    document.getElementById('confirmDeleteGroupButton').href = "<?php echo e(url('admin/deleteGroup')); ?>/" + groupId;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My project\E-learning - Copie\resources\views/admin/controlGroup.blade.php ENDPATH**/ ?>