    ...
    <div class="profile-container">
        ...
        <div class="profile-content">
            <div class="profile-section">
                ...
                <form action="<?php echo e(url('/profile/update')); ?>" method="POST" class="profile-form">
                    <?php echo csrf_field(); ?>
            ...
            <div class="profile-section">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($totalCourses ?? 0); ?></div>
                        <div class="stat-label">Cours suivis</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon">📝</div>
                        <div class="stat-value"><?php echo e($completedTests ?? 0); ?></div>
                        <div class="stat-label">Tests complétés</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon">🎯</div>
                        <div class="stat-value"><?php echo e($averageScore ?? '0%'); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My project\E-learning - Copie\resources\views/profile.blade.php ENDPATH**/ ?>