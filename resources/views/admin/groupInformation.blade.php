    ...
    <div class="admin-header mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ url('admin/controlGroup') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="student-list">
                        ...
                        <div class="student-item">
                            <div class="student-info">
                                <div class="student-avatar">{{ strtoupper(substr($user->name, 0, 2)) }}</div>
                                <div class="student-details">
                                    <div class="student-name">{{ $user->name }}</div>
                                    <div class="student-email">{{ $user->email }}</div>
                                </div>
                            </div>
                            <button class="btn btn-icon btn-danger" onclick="showDeleteStudentConfirmation('{{ $user->id }}', '{{ $user->name }}')" title="Retirer">
                    ...
                    <div class="section-list">
                        ...
                        <div class="section-item">
                            <div class="section-info">
                                <h4 class="section-name">{{ $sec->namesection }}</h4>
                                <div class="section-teacher">
                                    <i class="fas fa-chalkboard-teacher mr-1"></i>{{ $sec->name }}
                                </div>
                                <p class="section-description">{{ $sec->description }}</p>
                            </div>
                            <button class="btn btn-icon btn-danger" onclick="showDeleteSectionConfirmation('{{ $sec->id }}', '{{ $sec->namesection }}')" title="Supprimer">
...
<div class="modal fade" id="addSectionModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/infoGroup/addteacher/'.$grpInfo->id) }}" method="post">
                @csrf
...
<div class="modal fade" id="addStudentModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/infoGroup/affecterEtucdiant/'.$grpInfo->id) }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="notAff" class="form-control select2" required>
                            ...
                            @foreach($notAffect as $etd)
                                <option value="{{ $etd->id }}">{{ $etd->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
...
function showDeleteStudentConfirmation(id, name) {
    document.getElementById('confirmDeleteStudentButton').href = "{{ url('admin/infoGroup/delete_studiant_from_group') }}/" + id;
...
function showDeleteSectionConfirmation(id, name) {
    document.getElementById('confirmDeleteSectionButton').href = "{{ url('admin/infoGroup/delete_section_from_group') }}/" + id;
