        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right">
                <div class="exam-timer" id="examTimer">
                    ...
                    <span id="timer">{{ $data->duree }}:00</span>
                </div>
            </div>
        </div>
    </div>

    <form action="{{ url('home/mesCours/examen/storeOptionExam/'.$id) }}" method="get" id="examForm">
            ...
            <div class="question-card">
                ...
                <div class="options-list">
                    ...
                    <label class="option-item">
                        <input type="radio" name="{{ $q->id }}" value="{{ $opt->options }}" required>
